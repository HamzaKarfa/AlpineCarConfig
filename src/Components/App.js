          ...
          <Navbar bg='transparent' variant='dark'>
            <Container>
              ...
              <Nav className='me-auto'>
                <Link to='/'>
                  <img src='images/home_house_icon-icons.com_49851.png'></img>
                </Link>
              </Nav>
            </Container>
          </Navbar>
    ...
    <div className='stylehomepage'>
      ...
      <div className='d-flex -justify-content-center'>
        <div className='col-sm-6 modeles'>
          <h1>MODÈLES</h1>
          <p>
            VIVEZ L'EXPÉRIENCE ALPINE<br></br>À VOTRE FAÇON
          </p>
        </div>
      ...
      <div className='creation'>
        <div className='d-flex -justify-content-center align'>
          <div className='col-sm-6 moteur'>
            <h1>
              Moteur <br /> turbocompressé
            </h1>
            <p>
              Avec une puissance maximale de 292 ch, l'A110S est le modèle{' '}
              <br /> le plus puissant de la gamme A110. Le moteur quatre
              cylindres <br /> de 1,8 litre demeure, mais la pression de
              suralimentation du turbocompresseur est augmentée de 0,4 bar pour
              offrir de <br /> meilleures performances. Coupé deux places à
              moteur en position <br /> centrale arrière, l’A110S délivre
        ...
        <div className='Technologie'>
          <div className='d-flex -justify-content-center align'>
            ...
            <div className='col-sm-6 moteur'>
              <h1>Châssis Sport</h1>
              <p>
                Le réglage du châssis sport de l’A110S offre stabilité à haute
                vitesse et précision de la tenue de route, faisant de l’A110S
                une voiture de sport affutée. Les nouveaux ressorts hélicoïdaux
                sont plus rigides de 50% et les amortisseurs ont été réglés en
                conséquence. Les barres anti-roulis - creuses pour minimiser le
                poids - sont plus fermes de 100%.
              </p>
            </div>
          </div>
        </div>
        <div className='graviter mt-5 mb-5'>
          ...
          <div className='d-flex justify-content-center'>
            <video className='videocars' loop autoPlay>
              <source
                src='video/Center-of-gravity-FR_LOW.mov'
                type='video/mp4'
              />
            </video>
          </div>
